---
subtitle: "The theoretical background and mathematical foundations."
---

# Theory {#sec-theory}

IPPL provides the main building blocks for particle-mesh simulations. One such method is the Particle-in-Cell (PIC) method. In this section, we give a brief overview of the physics and numerical theory behind it. For further information, please see [@hockney1988] and [@birdsall2018]. 
...
In the case of collisions, the right-hand side of the Vlasov equation is non-zero, and this can be treated numerically in multiple ways. One of these is the P3M (Particle-Particle Particle-Mesh) method. 
