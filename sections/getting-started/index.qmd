...
The fastest first experiment is the browser playground in @sec-playground. Keep this manual open, start the local Docker runner, paste the token printed by the runner, then edit, compile, run, inspect stdout, and edit again.
