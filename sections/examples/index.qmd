...
| `solver_type` | Landau-compatible paths are `FFT`, `CG`, `PCG`, `FEM`, or `FEM_PRECON`; the generic `OPEN` solver exists in ALPINE but this miniapp rejects it because Landau damping is periodic. |
...
srun ./LandauDamping 256 256 256 134217728 20 PCG 0.1 LeapFrog \
  ssor 4 2 1.5707963 0 --overallocate 2.0 --info 5
```
...
For the local manager stack and execution flow, see @sec-alpine-manager-hierarchy.
