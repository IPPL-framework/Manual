---
subtitle: "Defining and operating on grid-based field data."
---
...
| dot product | `field = dot(vfield, vfield);` |
| inner product | `double val = innerProduct(field, field);` |
| volume integral | `rho.getVolumeIntegral();` |
| volume average | `rho.getVolumeAverage();` |

For differential operators such as gradient, divergence, curl, Hessian, and Laplacian, see @sec-differential-operators.
